...
namespace 코드흐름제어
{
    ...
    static class If조건문
    {
        public static void Show()
        {
            ...
            else // if와 함께 사용해야하며, 위의 if조건문이 아닐 때 실행된다.
            {
            ...
            //  4. 중괄호 없이 if문을 사용할 때 주의해야할 사항 -> 한줄만 사용해야 함.
            if(num2 > 5)
                Console.WriteLine("num2가 5보다 큽니다.");  // 조건문의 영향을 받는다.
                Console.WriteLine("그리도 이것도 출력됩니다."); //조건문과 상관없이 항상 실행된다.

            // 5. 조건이 여러개일 경우에는 어떻게 표현하면 되나요?
            Console.WriteLine("입력 값을 넣어주세요(1 : 게임시작, 2 게임종료, 3 : 옵션)");
            ...
            {
                Console.WriteLine("잘못된 입력 값입니다. 다시 입력해주세요");
            }
        }
    }
}
